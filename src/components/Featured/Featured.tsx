    ...
    <div className='featured'>
      <div className='featured__row'>
        <div className='featured__col3'>
          <img
            src={`${process.env.PUBLIC_URL}/images/test/category-1.jpg`}
            alt=''
          />
        </div>
        <div className='featured__col3'>
          <img
            src={`${process.env.PUBLIC_URL}/images/test/category-2.jpg`}
            alt=''
          />
        </div>
        <div className='featured__col3'>
          <img
            src={`${process.env.PUBLIC_URL}/images/test/category-3.jpg`}
            alt=''
          />
        </div>
      </div>
